...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "mymind",
		Short: "Manage mymind resources via the mymind API",
...
Discovery for agents:
  ...
  mymind api               browse every API endpoint`,
	...
	rootCmd.SetVersionTemplate("mymind {{ .Version }}\n")
	...
	rootCmd.AddCommand(newConvertPromotedCmd(flags))
	rootCmd.AddCommand(newEntitiesPromotedCmd(flags))
	rootCmd.AddCommand(newMymindSearchPromotedCmd(flags))
